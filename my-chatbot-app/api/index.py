...
def process_query(query: str, session_id: str) -> str:
    ...
    predefined_responses = {
        "power cut": {"hi": "🔌 बिजली रखरखाव के कारण बंद है, 2 घंटे में बहाल की जाएगी।", "en": "🔌 Due to maintenance, power will be restored in 2 hours."},
        "new connection": {"hi": "⚡ नया कनेक्शन के लिए https://www.sbpdcl.co.in पर ऑनलाइन आवेदन करें या नजदीकी विद्युत कार्यालय जाएं।", "en": "⚡ To apply for a new connection, visit https://www.sbpdcl.co.in or go to your nearest electricity office."},
        "office hours": {"hi": "📅 कार्यालय समय: सोमवार से शनिवार, सुबह 10:00 से शाम 5:00 बजे तक। रविवार को अवकाश।", "en": "📅 Office Hours: Monday to Saturday, 10:00 AM to 5:00 PM. Closed on Sundays."},
        "helpline": {"hi": "☎️ हेल्पलाइन: 1912 या 0612-3500120\n📧 ईमेल: support@sbpdcl.co.in", "en": "☎️ Helpline: 1912 or 0612-3500120\n📧 Email: support@sbpdcl.co.in"},
        "load shedding": {"hi": "🕒 लोड शेडिंग आमतौर पर शाम 6-8 बजे होती है। सही जानकारी के लिए क्षेत्रीय कार्यालय से संपर्क करें।", "en": "🕒 Load shedding usually occurs between 6-8 PM. For details, contact your local office."},
        "tariff": {"hi": "💡 घरेलू उपभोक्ताओं के लिए ₹6.10/यूनिट तक दरें लागू हैं। पूरी जानकारी: https://www.sbpdcl.co.in", "en": "💡 Domestic consumer rates go up to ₹6.10/unit. Full info: https://www.sbpdcl.co.in"},
        "subsidy": {"hi": "🎁 अनुसूचित जाति/जनजाति व BPL उपभोक्ताओं को सरकार द्वारा सब्सिडी दी जाती है। विवरण के लिए कार्यालय जाएं।", "en": "🎁 Subsidies are available for SC/ST and BPL consumers. Visit your office for details."},
        "smart meter": {"hi": "📡 स्मार्ट मीटर से आप मोबाइल ऐप से रियल-टाइम उपयोग देख सकते हैं। अधिक जानकारी के लिए sbpdcl.co.in पर जाएं।", "en": "📡 Smart meters let you monitor usage via app. Visit sbpdcl.co.in for more info."},
        "due date": {"hi": "📅 बिल का अंतिम तिथि हर महीने की 15 तारीख होती है।", "en": "📅 Bill due date is typically the 15th of every month."},
        "pay": {"hi": "💳 भुगतान UPI, नेट बैंकिंग, या CSC केंद्र से करें। पोर्टल: https://www.sbpdcl.co.in", "en": "💳 Pay via UPI, net banking, or nearby CSC center. Visit https://www.sbpdcl.co.in"}
    }
